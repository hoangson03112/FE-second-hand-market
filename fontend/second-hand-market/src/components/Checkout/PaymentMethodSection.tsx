...
import { PaymentOptionProps, PaymentMethodSectionProps } from "./types/Checkout.types";
  ...
  return (
    ...
    >
      <CardContent>
        ...
        {/* Benefits */}
        <List dense sx={{ p: 0 }}>
          {config.benefits?.slice(0, 3).map((benefit: string, index: number) => (
              ...
              <FormControlLabel
                ...
                label={
                  <PaymentOption
                    ...
                    onSelect={(method: string) => onPaymentMethodChange(method as any)}

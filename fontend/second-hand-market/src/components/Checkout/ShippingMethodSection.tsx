...
const ShippingMethodCard: React.FC<ShippingMethodCardProps> = ({ method, config, isSelected, onSelect }) => {
  return (
...
const ShippingInfoSection: React.FC<ShippingInfoSectionProps> = ({ method, config }) => {
...
const ShippingMethodSection: React.FC<ShippingMethodSectionProps> = ({ shippingMethod, onShippingMethodChange }) => {

...
const FloatingElement = styled(Box)(
  ({ theme, size = 100, color = "#e2e8f0", animation = "pulse" }) => ({
    position: "absolute",
    width: size,
    height: size,
    borderRadius: "50%",
  ...
  const features = [
    {
      ...
      desc: "Góp phần bảo vệ môi trường",
    },
    {
      icon: "💰",
      title: "Thu nhập ổn định",
      desc: "Kiếm tiền từ đồ cũ không dùng",
    },
    {
      icon: "🌱",
      title: "Cộng đồng xanh",
      desc: "Kết nối với người quan tâm môi trường",
    },
    {
      icon: "🚀",
      title: "Dễ dàng bắt đầu",
      desc: "Đăng ký nhanh chỉ trong 5 phút",
    },
  ];
          ...
          >
            ...
            <Box textAlign="center" mb={8}>
              ...
              >
                ...
                <span className="highlight">người bán thông minh</span> - Khởi
                nghiệp xanh với đồ cũ có giá trị!
              </Typography>
            </Box>
            ...
            <Box textAlign="center">
              <Paper
                sx={{
                  ...
                  borderRadius: 4,
                  background:
                    "linear-gradient(to right, rgba(42, 59, 76, 0.1), rgba(52, 73, 96, 0.1), rgba(62, 88, 113, 0.1), rgba(73, 104, 131, 0.1))",
              ...
              >
                ...
                <Typography variant="body1" color="text.secondary">
                  Tham gia cộng đồng kinh doanh bền vững và tạo ra tác động tích
                  cực cho môi trường
                </Typography>
              </Paper>

...
const VoucherManagement = () => {
  ...
  const getStatusChip = (voucher) => {
    ...
    if (!voucher.isActive) {
      return <GradientChip chipcolor="error" label="Vô hiệu hóa" size="small" />;
    }
    if (now < startDate) {
        ...
        <StyledCardContent>
          ...
          <StyledTableContainer component={Paper}>
            <Table>
              <StyledTableHead>
                  <TableRow>
  <TableCell sx={{ width: '20%' }}>Mã Voucher</TableCell>
  <TableCell sx={{ width: '15%' }}>Tên & Mô tả</TableCell>
  <TableCell sx={{ width: '12%' }}>Giá trị</TableCell>
  <TableCell sx={{ width: '12%' }}>Sử dụng</TableCell>
  <TableCell sx={{ width: '18%' }}>Thời hạn</TableCell>
  <TableCell sx={{ width: '13%' }}>Trạng thái</TableCell>
  <TableCell align="center" sx={{ width: '10%' }}>Thao tác</TableCell>
</TableRow>   
            </StyledTableHead>

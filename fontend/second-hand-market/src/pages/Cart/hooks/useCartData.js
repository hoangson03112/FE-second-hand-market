...
export const useCartData = () => {
    ...
    const fetchProductsWithQuantity = useCallback(async (cartItems) => {
        try {
            ...
            const productPromises = cartItems.map(item => getProduct(item.productId));
    ...
    const fetchSellers = useCallback(async (productList) => {
        try {
            ...
            const uniqueSellerIds = [...new Set(productList.map(product => product.sellerId))];

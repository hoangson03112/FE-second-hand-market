...
const DiscountBadge = styled(ProductBadge)(({ theme }) => ({
    ...
    <CardContainer viewMode={viewMode}>
          ...
          <BadgeContainer>
            {discountPercentage > 0 && (
              <DiscountBadge
                ...
                size="small"
                icon={<FlashOnOutlinedIcon sx={{ fontSize: "0.875rem" }} />}
              />
            )}
            {isNew && (
              <NewBadge
      ...
      <ContentSection viewMode={viewMode}>
        ...
        <PriceWrapper>
          ...
          {discountPercentage > 0 && (
            <OldPrice>{formatPrice(product.originalPrice)}</OldPrice>
          )}
        </PriceWrapper>
        ...
        {discountPercentage > 0 && (
          <SavingsBadge>
            <FlashOnOutlinedIcon sx={{ fontSize: "0.875rem" }} />
